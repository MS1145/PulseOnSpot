...
function formValidate() {
    ...
    if (document.getElementById("city").value == "") {
        alert("City section needs to be filled")
        return false
    }
    if (document.getElementById("zip").value == "") {
        alert("Zip-code section needs to be filled")
        return false
    }

    if (document.getElementById("ccnum").value == "") {
        alert("Card number section needs to be filled")
        return false
    }

    if (document.getElementById("expmonth").value == "") {
        alert("card expiry month section needs to be filled")
        return false
    }

    if (document.getElementById("expyear").value == "") {
        alert("card expiry year section needs to be filled")
        return false
    }

    if (document.getElementById("cvv").value == "") {
        alert("card CVV section needs to be filled")
        return false
    }
